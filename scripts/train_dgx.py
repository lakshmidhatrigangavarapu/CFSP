...
This script fine-tunes Phi-3.5-mini-instruct (3.8B) using LoRA for extracting
structured clinical factors from mental health clinical notes.
...
CLEARML_TASK_NAME = "Phi3.5-mini-LoRA-ClinicalFactorExtraction"
...
def format_prompt(note: str, schema: Dict) -> str:
    ...
    return (
        ...
        f"Return a JSON object matching the schema.<|end|>\n"
        f"<|assistant|>\n"
    )
