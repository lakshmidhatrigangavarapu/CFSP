"""
Centralized configuration for the full inference pipeline V4.

V4 additions over V3:
  - XAI evidence attribution settings
  - DOCX report generation settings
"""
...
# ============================================================================
# V4: XAI EVIDENCE ATTRIBUTION SETTINGS
# ============================================================================

# Minimum fuzzy match score to accept an evidence span
XAI_FUZZY_MATCH_THRESHOLD = 0.45

# Maximum evidence spans to include in DOCX (prevents overload)
XAI_MAX_SPANS_IN_DOCX = 30

# Branch color scheme (hex colors for DOCX highlighting)
XAI_BRANCH_COLORS = {
    "A": "FF4444",    # Red — Psychiatric Deterioration
    "B": "FF8C00",    # Orange — Substance Escalation
    "C": "4488FF",    # Blue — Social/Environmental Collapse
    "nexus": "FFD700", # Yellow — Multi-Branch Nexus Factor
}
